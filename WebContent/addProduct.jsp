				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="mobile">FRUITS</option>
							<option value="tv">VEGETABLES</option>
							<option value="camera">FARMING EQUIPMENTS</option>
							<option value="laptop">HAND HELD EQUIPMENT</option>
