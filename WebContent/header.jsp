				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=mobile">FRUITS</a></li>
							<li><a href="index.jsp?type=tv">VEGETABLES</a></li>
							<li><a href="index.jsp?type=laptop">SMALL FARMING EQUIPMENTS</a></li>
							<li><a href="index.jsp?type=camera">LARGE FARMING EQUIPMENTS</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=mobile">FRUITS</a></li>
							<li><a href="userHome.jsp?type=tv">VEGETABLES</a></li>
							<li><a href="userHome.jsp?type=laptop">SMALL FARMING EQUIPMENTS</a></li>
							<li><a href="userHome.jsp?type=camera">LARGE FARMING EQUIPMENTS</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=mobile">FRUITS</a></li>
							<li><a href="adminViewProduct.jsp?type=tv">VEGETABLES</a></li>
							<li><a href="adminViewProduct.jsp?type=laptop">SMALL FARMING EQUIPMENTS</a></li>
							<li><a href="adminViewProduct.jsp?type=camera">LARGE FARMING EQUIPMENTS</a></li>
						</ul></li>
